...
// import { AuthContext } from "../providers/AuthProvider"; // ✅ (optional if using Firebase)

const MyProfile = () => {
  // ⚙️ if you’re using Firebase, you’ll get user data like this:
  // const { user } = useContext(AuthContext);

  // Temporary static example for now:
  const user = {
    displayName: "John Doe",
    email: "john.doe@example.com",
    photoURL: "https://i.postimg.cc/DZtbnfBf/user-avatar.jpg",
  };
